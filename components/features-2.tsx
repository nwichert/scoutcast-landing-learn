    ...
    return (
        <section id="product" className="dark bg-background scroll-mt-20">
            <div className="mx-auto max-w-5xl px-6 py-24">
                <h2 className="mx-auto mb-14 max-w-3xl text-balance text-center text-4xl font-semibold tracking-tight text-foreground sm:text-[44px] sm:leading-[1.15]">Personalized down to the player.</h2>
