        ...
        <div className="bg-background min-h-screen text-foreground">
            ...
            <main className="mx-auto max-w-3xl px-6 pb-32 pt-16">
                ...
                <div className="mt-14 space-y-5 text-[17px] leading-[1.7] text-foreground/80">
                    ...
                    <p>
                        These Terms of Service (the &ldquo;Terms&rdquo;) are a contract between you and Scoutcast.ai, Inc. (&ldquo;Scoutcast,&rdquo; &ldquo;we,&rdquo; and &ldquo;us&rdquo;) and required to use the App. These Terms include the provisions on this page and in our{" "}
                        <Link
                            href="/privacy"
                ...
                <LegalSection title="Your Subscription">
                    ...
                    <LegalSubsection title="Plans and Tiers">
                        ...
                        <LegalList
                            items={[
                                "Free Trial: all new accounts receive a 7-day free trial of Scoutcast Plus at no cost and with no credit card required. During the trial, you have full access to Scoutcast Plus features. If you do not subscribe before the trial ends, your briefings stop and no charge is made.",
                                "Scoutcast Plus (Monthly or Annual): a paid, auto-renewing subscription available in monthly and annual billing periods. Includes unlimited Casts, daily personalized audio briefings, and tap-to-ask audio follow-ups. Casts you stop listening to may be automatically paused after several skipped episodes and can be resumed at any time.",
                                "NFL Fantasy Pass: a separate, paid, auto-renewing yearly subscription for fantasy-football content. It is sold separately, is required to access personal fantasy analyst features, and does not require a Scoutcast Plus subscription.",
                                "League Pass: a separate, paid, seasonal purchase covering a single fantasy league. The purchaser (typically the league commissioner) pays for the season, and members of that league can access League Pass content at no charge via an invite code. Available for Sleeper leagues at launch.",
                            ]}
                        />
                    </LegalSubsection>
                    ...
                    <LegalSubsection title="NFL Fantasy Content">
                        <p>The NFL Fantasy subscription provides AI-generated informational fantasy-football content and audio briefings &mdash; such as matchup analysis, start/sit perspectives, and projections. It is an entertainment and information service only. It does not operate, host, or enter you into any daily fantasy sports (DFS) contest or other fantasy contest, does not collect entry fees, and does not award prizes, cash, or anything of value. As described in the &ldquo;Gambling, Wagering, and Betting Disclaimer&rdquo; section below, you may not use this or any other App content for gambling, wagering, or DFS contest purposes.</p>
                    </LegalSubsection>
                ...
                <LegalSection title="Gambling, Wagering, and Betting Disclaimer">
                    <LegalSubsection title="No Gambling Advice or Endorsement">
                        <p>Scoutcast is an entertainment and informational platform only. Nothing in the App&mdash;including AI-generated audio briefings, sports analysis, player statistics, game predictions, fantasy projections, injury reports, or any other content&mdash;constitutes gambling advice, betting guidance, wagering recommendations, or financial advice of any kind. Scoutcast does not endorse, promote, facilitate, or encourage gambling, sports betting, daily fantasy sports contests, or any other form of wagering activity. For clarity, the paid NFL Fantasy subscription provides only informational fantasy-football content and audio briefings as described in the &ldquo;Your Subscription&rdquo; section above; it does not operate, host, or enter you into any fantasy or daily fantasy sports (DFS) contest, collect entry fees, or award prizes, cash, or anything of value.</p>
                ...
                <LegalSection title="Dispute Resolution">
                    <LegalSubsection title="Governing Law">
                        <p>These Terms and your use of the App will be governed by the laws of the State of Michigan and United States law, without regard to conflict-of-law rules. You and Scoutcast agree to submit to the state courts located in Washtenaw County, Michigan or the United States District Court for the Eastern District of Michigan (the &ldquo;Michigan Courts&rdquo;) for any actions where either party seeks injunctive or other equitable relief to prevent infringement or violation of intellectual property rights, as described in the &ldquo;Arbitration and Class Action Waiver&rdquo; subsection below.</p>
                    </LegalSubsection>
